...
*	20220810	analysis_rates_graph	Added tif file graph with 1200dpi
*	20220912	analysis_rates_graph	Added eps file and renamed labels to "4-11" rather than "4 to 11" etc.
*************************************
...
graph twoway (bar upper ycat_m if inrange(ycat_m, 15, 18), bcolor(gs14) base(0) lwidth(none)) ///
			 ...
			 label(4 "Males 4-11 years") label(5 "Males 12-18 years") ///
			 label(6 "Females 4-11 years") label(7 "Females 12-18 years")) ///
...
graph export "outputs/Fig1.tif", width(7560) replace
graph export "outputs/Fig1.eps", replace
